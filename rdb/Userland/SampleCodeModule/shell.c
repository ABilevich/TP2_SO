...
static char *runable_name[] = {"a", "b", "c", "d", "e", "test_mem", "loop", "test_proc", "test_prio", "test_sem2", "wc", "filter", "cat", "test_sync", "test_async"};
static void (*runable_func[])(void) = {start_a, start_b, start_c, start_d, start_e, test_mm, start_loop, test_processes, test_prio, test_sem, start_wc, start_filter, start_cat, run_test_sync, run_test_async};
