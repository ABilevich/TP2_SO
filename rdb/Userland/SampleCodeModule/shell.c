...
static char *runable_name[] = {"a", "b", "c", "d", "e", "test_mem", "test_sem", "loop", "test_proc", "test_prio", "test_sync_async"};
static void (*runable_func[])(void) = {start_a, start_b, start_c, start_d, start_e, test_mm, test_sem, start_loop, test_processes, test_prio, test_sync_async};
